...
/**
 * {@link ContentProvider} for inventorya app.
 */
public class ProductProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.android.inventoryapptz/inventoryapptz"
        // will map to the
        // integer code {@link #PRODUCTS}. This URI is used to provide access to MULTIPLE rows
        // of the products table.
        sUriMatcher.addURI(ProductContract.CONTENT_AUTHORITY, ProductContract.PATH_PRODUCTS, PRODUCTS);

        // The content URI of the form "content://com.example.android.inventoryapptz/inventoryapptz/#" will map to the
        // integer code {@link #PRODUCTS_ID}. This URI is used to provide access to ONE single row
        // of the products table.
        //
        // In this case, the "#" wildcard is used where "#" can be substituted for an integer.
        // For example, "content://com.example.android.inventoryapptz/inventoryapptz/3" matches, but
        // "content://com.example.android.inventoryapptz/inventoryapptz" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case PRODUCTS_ID:
                ...
                // For an example URI such as "content://com.example.android.inventoryapptz/inventoryapptz/3",
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        // check that price is greater than or equal to 0 (some products can be
        // added to other products as a gratis so their price can be 0)
